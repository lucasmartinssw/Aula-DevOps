...
const places = [
  {
    ...
    desc: "Machu Picchu é uma antiga cidade Inca envolta por montanhas e névoa. Um lugar onde engenharia, espiritualidade e natureza se unem.",
    exp: "Nascer do sol nas montanhas"
  },
  {
    name: "Kyoto – Japão",
    coords: [35.0116, 135.7681],
    img: "assets/images/kyoto.jpg",
    desc: "Kyoto preserva a alma do Japão tradicional, com templos, jardins zen e florestas de bambu imensas.",
    exp: "Cerimônia do chá em Gion"
  },
  {
  ...
  },
  {
    ...
    exp: "Explorar o templo Ta Prohm"
  },
  {
    ...
    exp: "Voo de balão ao nascer do sol"
  },
  {
  ...
  },
  {
    ...
    exp: "Fotos em perspectiva no horizonte"
  }
];
...
if (typeof L !== 'undefined' && document.getElementById('map')) {
    ...
    // MUDANÇA: Usando OpenStreetMap (Claro) ao invés do CartoDB Dark
    ...
    places.forEach(p => {
        L.marker(p.coords)
            .addTo(map)
            .bindPopup(`<b>${p.name}</b><br><img src="${p.img}" style="width:100px; margin-top:5px; border-radius:5px;">`);
    });
}
...
if (contactForm) {
    contactForm.addEventListener('submit', async (e) => {
        ...
        // Simulação de envio para demonstração visual
        setTimeout(() => {
            alert(`Obrigado, ${nome}! Mensagem recebida (Simulação).`);
            contactForm.reset();
